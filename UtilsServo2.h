...
#ifndef UtilsServo2_h
#define UtilsServo2_h
...
class UtilsServo2 {
  ...
  public :
	...
	Servo _servos[12]; // tableau interne des objets servomoteurs - 12 max pour Arduino UNO

  
  public :
  	UtilsServo2(); // constructeur
  	//UtilsServo(Servo *servos, float (*anglesServosIn)[3], int nombreServosIn); // constructeur
	UtilsServo2(int nombreServosIn); // constructeur
