/*
 * Copyright (c) 2012 - 2015 by Xavier HINAULT - support@mon-club-elec.fr
 *
...
#include "Servo.h"
//#include "Utils.h"
#include "UtilsServo2.h"

  UtilsServo2::UtilsServo2(){ // constructeur par défaut 
  
  }

  //UtilsServo::UtilsServo(Servo *servos, float (*anglesServosIn)[3], int nombreServosIn){ // constructeur 
  UtilsServo2::UtilsServo2(const int nombreServosIn){ // constructeur 
...
void UtilsServo2::anglesServo(int index,float angle0, float angle1, float angle2){ // initialise angles du servomoteur 
...
void UtilsServo2::init(int brochesServosIn[]) {
...
void UtilsServo2::vitesseServos(int delaiVitesse){
...
//---- désactivation debug
void UtilsServo2::debug(boolean debugIn){
...
float  UtilsServo2::angle(float valeur_angle) { 
...
void UtilsServo2::servo(int indexServo,float toAngle) {
...
//------ fonction de positionnement progressif du servomoteur par pas fixe - angle absolu ----- 
 ...
 void UtilsServo2::servoTo( Servo toServo, float fromAngle, float toAngle, int toVitesse, int toPas) {
...
void UtilsServo2::servoTo( int indexServo, float toAngle){
...
//--- fonction de positionnement progressif du servomoteur par pas fixe - angle relatif à la position courante  ----- 
 ...
 void UtilsServo2::servoToR( Servo toServo, float fromAngle, float toAngle, int toVitesse, int toPas) {
...
void UtilsServo2::servoToR( int indexServo, float toAngle){
...
void UtilsServo2::servosSync( float S0, float S1, float S2, float S3, float S4 , float S5, float S6, float S7, float S8, float S9, float S10, float S11) { // reçoit les angles absolus des servos
...
void UtilsServo2::servosSync( float S0, float S1, float S2, float S3, float S4) { // reçoit les angles absolus des servos
...
void UtilsServo2::servosSync( float S0, float S1) { // reçoit les angles absolus des servos
...
void UtilsServo2::servosSync( float S[], int tailleIn) { // reçoit les angles absolus des servos
...
//---------- servosSync() = fonction de positionnement synchronisé des servomoteurs du robot en position absolue - 12 valeurs ------ 
void UtilsServo2::servosSyncR( float S0, float S1, float S2, float S3, float S4 , float S5, float S6, float S7, float S8, float S9, float S10, float S11) { // reçoit les angles absolus des servos
...
void UtilsServo2::servosSyncR( float S0, float S1, float S2, float S3, float S4) { // reçoit les angles absolus des servos
...
//---------- servosSyncR() = fonction de positionnement synchronisé des servomoteurs du robot en position relative - 5 valeurs ------ 
void UtilsServo2::servosSyncR( float S0, float S1) { // reçoit les angles absolus des servos
...
void UtilsServo2::servosSyncR(float S[], int tailleIn) { // reçoit les angles relatifs des servos
